                        ...
                        <div id="wt-main" class="wt-main wt-features settings-main-wrap">
						    <div class="wt-featurescontent">
                                ...
                                <ul class="wt-tabsnav">
									...
									<?php if( isset( $chat['gadget'] ) && ( $chat['gadget'] === 'chat' || $chat['gadget'] === 'inbox' ) ){?>
										...
										<?php if( isset( $_GET['tab'] ) && ( $chat['gadget'] === 'chat' || $chat['gadget'] === 'inbox' ) && !empty($usersThreadUserList) ){?>
								...
								<?php if( isset( $_GET['tab'] ) &&  $_GET['tab'] === 'chat' && ( $chat['gadget'] === 'chat' || $chat['gadget'] === 'inbox' ) ){?>
